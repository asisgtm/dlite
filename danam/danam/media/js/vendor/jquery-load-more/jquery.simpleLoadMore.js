...
(function($) {
  $.fn.simpleLoadMore = function( options ) {
    ...
    $loadMore.each(function(i, el) {
      ...
      var btnHTML       = settings.btnHTML ? settings.btnHTML : '<button type="button" id="portfolioLoadMore" class="btn btn-dark btn-outline font-weight-extra-bold text-3 px-5 py-3 border-width-4 appear-animation-animated fadeInUpShorter load-more__btn">Load More</button>';
      var $btnHTML      = $(btnHTML);
